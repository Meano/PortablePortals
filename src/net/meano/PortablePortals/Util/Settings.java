...
public class Settings {
	...
	public static boolean isItemRequired() {
		return PortablePortals.me.getConfig().getBoolean(
				"Require Item To Use.Enabled");
	}

	public static int portalRefreshTime() {
		return PortablePortals.me.getConfig().getInt(
				"Portals.Check If In Portal Refresh Time") * 20;
	}
